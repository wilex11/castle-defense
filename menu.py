...
class Menu(object):
    def __init__(self):
        self.menudict={"root":["Play","Difficulty", "Help", "Credits", "Instruction" ,  "Options","Quit"],
        
                       "Options":["Turn music off","Turn sound off","Change screen resolution","bbb"],
                       ...
                       "Instruction":["To shoot with the Archer,klick Leftmousebutton","To shoot with the cannons,klick Rightmousebutton", "To see the range of the archer and cannons press R"]
                       } 
        self.menuname="root"
        self.menuname_old = []
